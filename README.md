...
# Devtool Usage Analytics

![Demo Screenshot](demo/screenshot.png)

## Overview
Analyze seat activation, retention, and workspace behaviors for developer-focused products.
...
## Project Profile
- Domain: Developer Product Analytics
- Project type: `analytics`
- Tags: developer-tools, product, usage
